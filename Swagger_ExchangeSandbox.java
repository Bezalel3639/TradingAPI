...
public class Swagger_ExchangeSandbox {
    ...
    public String ExchangePair(
    	    ...
    	    @PathVariable @ApiParam(defaultValue = "BTC") String asset1,
    	    @PathVariable @ApiParam(defaultValue = "0.000002") String asset1_amount, // 200 satoshi
    	    ...
    	    @PathVariable @ApiParam(defaultValue = "-1") String asset2_amount, // not used in scenario 2
