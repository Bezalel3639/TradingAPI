...
public class Swagger_Bitcoin {
    ...
    public boolean IsAddressValid(String address) throws Exception { 
    ...
    public String getBTCRate() throws Exception {
     	String result = null;
    ...
    @RequestMapping(path="/Bitcoin/SendFromAddress/{addressfrom}/{addressto}/{amount}/{password}", method = RequestMethod.POST)
    @ApiOperation(value="Send BTC", tags="Bitcoin API")
    public ResponseEntity<String> sendBTC(
            @PathVariable @ApiParam(defaultValue = "15CCuZX353pBagPdbLmCimFwQLNtAP82JX") String addressfrom, 
            @PathVariable @ApiParam(defaultValue = "1Dy7ZKCxKt51rDYkr6tjvNcX1ivuVQDFSC") String addressto, 
            @PathVariable @ApiParam(defaultValue = "0.00011") double amount,
