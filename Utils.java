...
public class Utils {
    ...
    public String logFiatDepositResultsFromYandex (
            String currency,
            double amount,
            double transaction_fee,
            String emailfrom,
        ...
        Settings settings = new Settings();
        String db_name = "logs";
        String collection = "fiat_deposits";
        ...
        results_obj.put("amount", amount);
        results_obj.put("fee", transaction_fee);
        results_obj.put("provider", "Yandex.Money");
        results_obj.put("emailfrom", emailfrom);
        results_obj.put("emailto", "stan1368@yandex.ru");
        results_obj.put("label", label); 
        results_obj.put("transaction_id", transaction_id);
        results_obj.put("tx_result", tx_result); 
        results_obj.put("notes", notes);  
    ...
    public String logFiatWithdrawalResultsFromYandex (
            String currency,
            double amount,
            String provider, 
            String emailfrom,
        ...
        Settings settings = new Settings();
        String db_name = "logs";
        String collection = "fiat_withdrawals";
        ...
        results_obj.put("emailfrom", emailfrom);
        results_obj.put("emailto", emailto);
        results_obj.put("transaction_id", tx_id);
        results_obj.put("tx_result", tx_result); 
        results_obj.put("notes", notes); 
